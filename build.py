...
CSS = r"""
  ...
  *{box-sizing:border-box}
  ...
  .card h3{margin-bottom:9px;display:flex;align-items:center;gap:11px}
  .card p{margin:0;font-size:15.5px}
  .card.bad h3{color:var(--muted)}
  .card.good h3{color:var(--accent)}
  /* scanning cue: a muted cross against the DIY card, the brand tick against ours.
     Drawn in CSS so it stays crisp and needs no icon font or extra request. */
  .mk{flex:0 0 auto;width:26px;height:26px;border-radius:50%;position:relative;
      display:inline-block;margin-top:1px}
  .card.bad .mk{background:var(--panel-3);border:1px solid var(--line)}
  .card.good .mk{background:var(--accent-soft);border:1px solid var(--accent)}
  .card.bad .mk::before,.card.bad .mk::after{content:"";position:absolute;left:50%;top:50%;
      width:11px;height:2px;border-radius:1px;background:var(--muted)}
  .card.bad .mk::before{transform:translate(-50%,-50%) rotate(45deg)}
  .card.bad .mk::after{transform:translate(-50%,-50%) rotate(-45deg)}
  .card.good .mk::before{content:"";position:absolute;left:50%;top:46%;width:11px;height:5.5px;
  ...
  @media(max-width:880px){.step{grid-template-columns:52px 1fr}.step .sc,.step p{grid-column:2}}
  ...
  @media(max-width:620px){.shelf figure{flex:0 0 76px}}
...
<main id="top">
  ...
  <section>
    <div class="wrap">
      ...
      <div class="split" style="margin-top:38px">
        <div class="card bad">
          <h3><span class="mk" aria-hidden="true"></span>Generating a cover yourself</h3>
          <p>
        ...
        <div class="card good">
          <h3><span class="mk" aria-hidden="true"></span>Working with KDPChimp</h3>
          <p>
  ...
  <section id="reviews">
    <div class="wrap">
      ...
      <h2>Rated 4.9/5 by the publishers we work with.</h2>
      ...
      <div class="price-wrap">
        <div class="price">
          ...
          <ul class="ticks">
            ...
            <li>Our six-point cover review &mdash; plus the grayscale and blur tests</li>
...
const CONFIG = {
  ...
  quotes: [
    /* Every quote is VERIFIED word-for-word - either from the customer's own
       email (Sept 2026 inbox audit) or from the live kdpchimp.com/testimonials
       page. "…" marks where a longer message was shortened. All are about BOOK
       COVERS specifically, not A+ content. None name Josiah personally - the
       praise is aimed at the studio, which is what we want on a sales page. */
    { t:"Their attention to detail in the graphics, design, and formatting of my book cover was what truly brought my vision to life", n:"Urbi Ghosh", d:"Book cover client" },
    { t:"I had the pleasure of working with… KDPChimp for the cover of my newest coloring book, and I couldn't be more thrilled with the results!", n:"Chris Roberts", d:"Maxwell Pawsworth" },
    { t:"If you need a visually stunning book cover… KDPChimp can do it all!", n:"Lucy &amp; Joseph Naim", d:"Book cover clients" },
    { t:"…design skills are nothing short of extraordinary… a unique artistic flair that elevated our project beyond our expectations", n:"Angela &amp; Gérald", d:"Book cover clients" },
    { t:"I agree that your cover is better than the one I submitted to you!", n:"Dean Gemberling", d:"Book cover client" },
    ...
    { t:"Partnering with KDPChimp was an exceptional experience from start to finish. Their professionalism, expertise, and meticulous attention to detail far exceeded my expectations.", n:"S.L. Jungle", d:"KDPChimp client" }
  ]
};
...
(function(){
  ...
  if(shelf){
    ...
    // On a narrow screen the row is wider than the viewport and our cover starts
    // off-screen, which is exactly the thing the section exists to show. Nudge the
    // row (not the page) so our cover is in view from the start.
    const centreMine=()=>{
      const m=shelf.querySelector('.mine'); if(!m) return;
      const target=m.offsetLeft-(shelf.clientWidth-m.offsetWidth)/2;
      shelf.scrollLeft=Math.max(0,target);
    };
    if(shelf.scrollWidth>shelf.clientWidth) centreMine();
    window.addEventListener('load',()=>{ if(shelf.scrollWidth>shelf.clientWidth) centreMine(); });
  }
...
<meta property="og:url" content="https://covers.kdpchimp.com/">
<meta property="og:site_name" content="KDPChimp">
<meta property="og:image" content="https://covers.kdpchimp.com/assets/og.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="Three KDPChimp book covers beside the headline: the cover is the ad, yours should earn the click.">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="Professional Book Cover Design for Amazon KDP | KDPChimp">
<meta name="twitter:description" content="The cover is the ad. Yours should earn the click. $499, every format, layered source files you own.">
<meta name="twitter:image" content="https://covers.kdpchimp.com/assets/og.jpg">
<link rel="canonical" href="https://covers.kdpchimp.com/">
